...
""" 
    This script is used to test the model on the test dataset and save the results to a CSV file. 
"""
if __name__ == "__main__":
    ...
    results.to_csv("results/raw_data/test_metrics.csv", index=False)
