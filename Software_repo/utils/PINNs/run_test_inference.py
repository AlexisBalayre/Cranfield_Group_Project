...
from utils.PINNs.model.TurbulenceDataModule import TurbulenceDataModule
from utils.PINNs.model.TurbulenceModelPINN import TurbulenceModelPINN
...
def run_test_inference(
    ...
    """
    Runs inference on the test dataset using the specified model checkpoint and saves predictions. This method is used to compute the MSE over the test dataset.
...
# DECOMMENT THE FOLLOWING LINES TO RUN THE TEST INFERENCE - DEBBUGING ONLY
# if __name__ == "__main__":
#     run_test_inference(
#         model_checkpoint_path="epoch=20332-step=731988.ckpt",  # Trained model
#         test_dataset_path="/Users/alexis/Cranfield/Group Project/Repos1/TurbulenceModelPINN/data/channel/test_dataset.csv",  # input csv path generated by prepare_prediction_csv method
