...
def run_inference(
    ...
    """
    Runs inference on a specified prediction dataset using the specified model checkpoint and saves predictions.
...
# DECOMMENT THE FOLLOWING LINES TO RUN THE INFERENCE - DEBBUGING ONLY
